...
//inner text
navAnchors[0].textContent("Service");
...
newNavItem1.textContent = "Chat"; //add text to the new nav elem
...
newNavItem2.textContent = "Reviews"; //add text to the new nav elem
...
newHeader2.appendChild(newNavItem2);
